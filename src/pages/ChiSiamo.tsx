      ...
      <section className="pt-32 pb-24">
        <div className="container-padding">
          <div className="text-center mb-16">
            <span className="bg-accent-purple/10 text-accent-purple px-4 py-1.5 rounded-full text-sm font-medium dark:bg-[#5a8f67]/20 dark:text-[#5a8f67]">
              LA NOSTRA STORIA
            </span>
            <h1 className="heading-lg mt-6">Chi Siamo</h1>
            <p className="text-neutral-600 mt-4 max-w-2xl mx-auto dark:text-neutral-400">
            ...
            <div className="space-y-6 order-2 md:order-1">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-neutral-600 dark:text-neutral-400">Promuoviamo scelte eco-sostenibili in ogni aspetto della vita quotidiana.</p>
                </li>
                <li className="flex items-start gap-3">
                  <span className="font-semibold min-w-32">Innovazione</span>
                  <p className="text-neutral-600 dark:text-neutral-400">Utilizziamo la tecnologia per rendere la sostenibilità accessibile a tutti.</p>
                </li>
                <li className="flex items-start gap-3">
                  <span className="font-semibold min-w-32">Comunità</span>
                  <p className="text-neutral-600 dark:text-neutral-400">Creiamo una rete di persone impegnate per un futuro migliore.</p>
                </li>
              </ul>
            </div>
